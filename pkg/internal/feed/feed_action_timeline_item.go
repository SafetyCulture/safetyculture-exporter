...
type ActionTimelineItem struct {
	...
	ActionCreatorID   string    `json:"action_creator_id" csv:"action_creator_id"`
	ActionCreatorName string    `json:"action_creator_name" csv:"action_creator_name"`
	Timestamp         time.Time `json:"timestamp" csv:"timestamp" gorm:"index:idx_act_tim_modified_at,sort:desc"`
