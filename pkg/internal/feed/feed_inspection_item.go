...
func (f *InspectionItemFeed) processInspectionItemsInBlocks(ctx context.Context, apiClient *httpapi.Client, exporter Exporter, orgID string, status *ExportStatus) error {
	...
	if !ok {
		...
		return f.processInspectionItemsInBlocksSequential(ctx, apiClient, exporter, orgID, status, blocks)
	}
	...
	processBlock := func(
		...
		return DrainFeed(ctx, apiClient, &req, drainFn)
	}
...
// processInspectionItemsInBlocksSequential is the fallback sequential implementation
func (f *InspectionItemFeed) processInspectionItemsInBlocksSequential(
	ctx context.Context,
	apiClient *httpapi.Client,
	exporter Exporter,
	orgID string,
