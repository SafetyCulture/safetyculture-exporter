...
def set_table(table, merge):
    class Database(Base):
        if merge is False:
            ...
            AuditID = Column(String(50), primary_key=True, autoincrement=False)
            ItemID = Column(String(50), primary_key=True, autoincrement=False)
            DatePK = Column(String(10), primary_key=True, autoincrement=False)
            ResponseID = Column(String(50))
            ParentID = Column(String(50))
            AuditOwner = Column(String(None))
            AuditAuthor = Column(String(None))
            AuditOwnerID = Column(String(None))
            AuditAuthorID = Column(String(50))
            ...
            TemplateAuthorID = Column(String(50))
            ItemCategory = Column(String(None))
            RepeatingSectionParentID = Column(String(50))
