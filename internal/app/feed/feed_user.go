...
type User struct {
	...
	Email          string    `json:"email" csv:"email" gorm:"size:5000"`
	Firstname      string    `json:"firstname" csv:"firstname" gorm:"size:500"`
	Lastname       string    `json:"lastname" csv:"lastname" gorm:"size:500"`
