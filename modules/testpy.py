...
class SafetyCulture:
    ...
    def authenticated_request_post(self, url, data):
        ...
        if self.proxy is not None:
            if self.certs is not None:
                response = requests.post(url, data, headers=self.custom_http_headers, proxies=self.proxy, certs=self.certs)
            else:
    ...
    def authenticated_request_put(self, url, data):
        ...
        if self.proxy is not None:
            if self.certs is not None:
                response = requests.put(url, data, headers=self.custom_http_headers, proxies=self.proxy, certs=self.certs)
            else:
